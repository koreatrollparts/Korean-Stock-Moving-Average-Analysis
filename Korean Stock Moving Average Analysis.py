...
def main():
        ...
        try:
            ...
            if enable_stability_analysis:
                ...
                if not stability_results.empty:
                    ...
                    st.write("💡 분석 완료 후 아래에서 행을 선택하여 상세 차트를 확인할 수 있습니다.")
    ...
    # 세션 상태에 저장된 안정성 분석 결과가 있으면 표시 (분석 버튼 외부에서도 동작)
    if st.session_state.stability_results is not None and not st.session_state.stability_results.empty:
